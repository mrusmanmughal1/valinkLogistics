  ...
  return (
    <div className="h-screen overflow-hidden relative    ">
      ...
      <div className="    h-full">
        <div className="absolute w-3/4  md:w-1/4 right-[10%] flex flex-col gap-3 top-[43%] md:top-[20%]  ">
          <p className="text-3xl text-blue-primary  font-semibold  uppercase   font-serif drop-shadow-md text-red  ">
            <Typewriter
              words={[
          ...
          <a href="#quote"  className="bg-blue-primary rounded-md py-4  text-center uppercase shadow-xl text-white font-semibold">
            Get a Quote
          </a>
        </div>
      </div>
