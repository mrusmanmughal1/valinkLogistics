    ...
    <div className="bg-orange-200 p-10 md:p-20  border-2">
      <div className="flex justify-center items-center   ">
        <div className="flex justify-center flex-col relative shadow-lg  shadow-orange-400">
          <div className="text-bold  font-bold  bg-white text-orange-600  drop-shadow-md text-center ext-lg  md:text-2xl p-4">
            QUOTE DETAILS
          </div>
      <span class="animate-ping absolute inline-flex h-5  w-5 right-0 top-0  rounded-full bg-orange-700 opacity-75"></span>

          <div className=" space-y-2 bg-white  border-2 p-10 text-lg md:text-2xl text-center font-semibold">
