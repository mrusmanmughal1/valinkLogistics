          ...
          {data.map((val, i) => {
            ...
            return (
              <div
                ...
                className={`${selected?._id == val?._id  && 'bg-orange-600'} space-y-4 text-center hover:bg-orange-600 hover:text-white rounded-md py-4 px-8`}
              >
                <div className={` ${selected?._id == val?._id  && '-translate-y-3 '} hover:-translate-y-3 transition-all duration-700 flex flex-col justify-center items-center`}>
                  <Image
